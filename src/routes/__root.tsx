...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "EventureByDesign — Luxury Event Planning, Watford UK" },
      { name: "description", content: "EventureByDesign crafts immersive luxury weddings, corporate galas and private celebrations. Designed experiences. Unforgettable moments." },
      { name: "author", content: "EventureByDesign" },
      { property: "og:title", content: "EventureByDesign — Luxury Event Planning, Watford UK" },
      { property: "og:description", content: "EventureByDesign crafts immersive luxury weddings, corporate galas and private celebrations. Designed experiences. Unforgettable moments." },
